...
class TracingFunctionDataFetcher(
    ...
    override fun runSuspendingFunction(
        ...
        return CoroutineScope(buildContext(environment)).future {
    ...
    private fun runBlockingFunction(
        ...
        val coroutineContext = buildContext(environment)
    ...
    private fun buildContext(environment: DataFetchingEnvironment): CoroutineContext {
        val graphQlContext = environment.graphQlContext
        return graphQlContext.openTelemetryElement() + graphQlContext.authenticationElementOrEmpty()
    }
